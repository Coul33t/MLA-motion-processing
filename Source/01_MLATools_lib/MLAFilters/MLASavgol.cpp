...
namespace savgol {
	...
	*****************************************************************/
	...
	std::vector<double> SavgolCoeffs(int np, int nl, int nr, int ld, int m)  {
		/*-------------------------------------------------------------------------------------------
	...
	std::vector<double> Savgol(std::vector<double>& data, unsigned int polynom_order, unsigned int window_size) {
		...
		std::vector<double> output_data(data.size(), 0.0);
		...
		std::vector<double> coefs = SavgolCoeffs(window_size, half_window, half_window, 0, polynom_order);
